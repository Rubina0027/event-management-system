...
$sql = "SELECT * FROM vendors WHERE username = '$name' ";
...
exit();
        ...
        elseif (count($errors) == 0)  {
            if(mysqli_query($db, "INSERT INTO vendors(username, email, category ,passcode) VALUES('" . $name . "', '" . $email . "', '" . $category . "', '" . md5($password) . "')")) {
